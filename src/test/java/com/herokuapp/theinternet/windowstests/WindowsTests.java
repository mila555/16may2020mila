...
public class WindowsTests extends TestUtilities {
	...
	public void newWindowTest() {
		...
		//introduction to driver.getPageSource() and perform assertion on text present on web page. ... or in IDE we normally select the text and by right clicking we normally add assert or verify method for specific text.
