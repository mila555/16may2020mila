...
public class EditorPage extends BasePageObject {
	...
	public String getEditorText() {
		switchToFrame(frame);
		// we are switching to Iframe first and then only we can locate the webelement
		//because iframe will not be under main html tag but it will be present under iframes in html
